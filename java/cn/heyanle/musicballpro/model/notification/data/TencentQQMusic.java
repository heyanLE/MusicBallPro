...
import static com.qmuiteam.qmui.util.QMUIDrawableHelper.drawableToBitmap;
            ...
            for (int i = 0; i < actionCount; i++) {
                ...
                if (resources != null) {
                    try {
                        ...
                        if (resources.getResourceEntryName(action.getIcon()).equals("player_notification_pause")){
                        ...
                        if (resources.getResourceEntryName(action.getIcon()).equals("player_notification_play")){
                        ...
                        if (resources.getResourceEntryName(action.getIcon()).equals("player_notification_next")){
                            FunctionInfo f = new FunctionInfo() {
                                @Override
                                public void run() throws Exception {
                                    action.actionIntent.send();
                        ...
                        if (resources.getResourceEntryName(action.getIcon()).equals("player_notification_pre")){
                            FunctionInfo f = new FunctionInfo() {
                                @Override
                                public void run() throws Exception {
                                    action.actionIntent.send();
